...
class Testaction:
    ...
    def test_action1_1_1(self, setup):
        ...
        check_resolve = self.driver.find_element(By.XPATH, "//*[@id='r_ticket_view']/div[1]/div[1]/span[1]/a").text

        if check_resolve == "RESOLVE":
            WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//*[@id='r_ticket_view']/div[1]/div[1]/span[1]/a"))).click()
            ...
            check_text = ["Resolved", "REOPEN"]

            check_status__ = self.driver.find_element(By.XPATH, "//*[@id='r_ticket_view']/div[1]/div[1]/span[2]").text
